...
highlight CursorIM guifg=white guibg=PaleTurquoise3
...
highlight DiffText guifg=fg guibg=bg
...
highlight Folded        guibg=bg guifg=#b0d0e0
...
highlight MoreMsg        guifg=SeaGreen4 guibg=bg
if version < 600
    " same as SpecialKey
...
highlight Question       guifg=SeaGreen2 guibg=bg
highlight Search        gui=NONE guibg=LightSkyBlue4 guifg=NONE
highlight SpecialKey    guibg=#103040 guifg=#627292
"highlight StatusLine    gui=NONE guibg=#555555 guifg=#CCCCCC 
highlight StatusLine    gui=NONE guifg=Cyan guibg=#507080
...
highlight WarningMsg    guifg=FireBrick1 guibg=bg
highlight WildMenu      guibg=Chartreuse guifg=Black
...
hi String gui=None guifg=turquoise2 guibg=bg
    ...
    highlight Boolean guifg=Cyan guibg=bg
...
highlight Statement     gui=NONE guifg=LightGreen
    ...
    highlight Keyword guifg=LightGreen guibg=bg
    highlight Exception guifg=LightGreen guibg=bg
...
highlight Special       guifg=aquamarine3
    "hi SpecialChar guifg=White guibg=bg
    "hi Tag guifg=White guibg=bg
    "hi Delimiter guifg=White guibg=bg
    "hi SpecialComment guifg=White guibg=bg
    "hi Debug guifg=White guibg=bg
