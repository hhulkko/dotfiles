...
let g:colors_name="desert_cygwin"
...
hi Normal ctermbg=black ctermfg=white
   ...
   hi statusline cterm=reverse ctermbg=3 ctermfg=6
...
hi IncSearch	cterm=NONE ctermfg=yellow ctermbg=darkred
...
hi link javaBoolean String
hi link javaConstant Statement
hi javaOperator ctermfg=cyan
hi link javaExceptions javaOperator
hi link javaLabel String
hi link javaNumber String
hi javaComment ctermfg=darkred
hi link javaLineComment Comment
hi javaCharacter ctermfg=magenta
hi link javaCommentString String
hi link javaString String
hi link javaComment2String String
hi link javaCommentCharacter String
hi javaStatement ctermfg=cyan
hi link javaConditional javaStatement
hi link javaRepeat javaStatement
"javaErrovar      xxx links to Error
...
hi javaType ctermfg=darkcyan
hi javaLangClass ctermfg=red
